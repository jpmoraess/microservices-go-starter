...
const file_trip_proto_rawDesc = "" +
	...
	"\x11totalPriceInCents\x18\x04 \x01(\x01R\x11totalPriceInCents\"\x8a\x01\n" +
	...
	"\trideFares\x18\x03 \x03(\v2\x0e.trip.RideFareR\trideFares2Q\n" +
	"\vTripService\x12B\n" +
...
var file_trip_proto_depIdxs = []int32{
	...
	1, // 1: trip.Route.geometry:type_name -> trip.Geometry
	0, // 2: trip.PreviewTripRequest.pickup:type_name -> trip.Coordinate
	0, // 3: trip.PreviewTripRequest.destination:type_name -> trip.Coordinate
	2, // 4: trip.PreviewTripResponse.route:type_name -> trip.Route
	3, // 5: trip.PreviewTripResponse.rideFares:type_name -> trip.RideFare
	4, // 6: trip.TripService.PreviewTrip:input_type -> trip.PreviewTripRequest
